# dAb2-Model
Whole-body PBPK model of a domain antibody dAb2 in mice [1].
...
**The latest release of the snapshot of the model, the evaluation plan and the static content can be found [here](https://github.com/Open-Systems-Pharmacology/dAb2-Model/releases/latest).**
